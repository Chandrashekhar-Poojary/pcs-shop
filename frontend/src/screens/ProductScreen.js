...
const ProductScreen = {
    ...
    after_render: () =>{
        ...
        document.getElementById("add-button").addEventListener('click', () => {
                document.location.hash = `/cart/${request.id}`; // cart api will call with product id
        });
    ...
    render: async () => {
        const request = parseRequestUrl(); // to send ajax request  to the server get all the information about the product
        ...
        <div class="content">
            <div class="back-to-result">
                <a href="/#/"><i class="fa fa-arrow-left" aria-hidden="true"></i>HOME</a>
            </div>
            <br>
            <div class="details">
